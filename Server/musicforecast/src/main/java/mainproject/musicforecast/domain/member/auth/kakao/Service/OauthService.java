...
//            Optional<Member> optionalMember = memberRepository.findBySub(stringSub);
            ...
            if(optionalMember.isPresent()) {
                ...
                member = saveGoogleMember(stringSub, email, nickname, "Google");
            }
    ...
    private Member saveGoogleMember(String memberNum, String email, String nickname, String providerName) {
