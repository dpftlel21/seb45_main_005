...
const Test = () => {
  ...
  const onSilentRefresh = async () => {
    ...
    try {
      const response = await axios.post(`${process.env.REACT_APP_BE_API_URL}/auth/login`, null, {
        headers: {
  ...
  const onLogin = async (email: string, password: string) => {
    ...
    try {
      const response = await axios.post(`${process.env.REACT_APP_BE_API_URL}/auth/login`, data, {
        headers,
      });
